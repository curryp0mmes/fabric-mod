...
public class M4CarbineModel extends AnimatedGeoModel<M4CarbineItem>
{
    ...
    {
        return new Identifier(RealisticGunsMod.MOD_ID, "geo/m4_carbine.geo.json");
    }

    @Override
    public Identifier getTextureLocation(M4CarbineItem object)
    {
        return new Identifier(RealisticGunsMod.MOD_ID, "textures/items/rifle_texture.png");
    }

    @Override
    public Identifier getAnimationFileLocation(M4CarbineItem object)
    {
        return new Identifier(RealisticGunsMod.MOD_ID, "animations/m4_carbine.animation.json");
    }
}