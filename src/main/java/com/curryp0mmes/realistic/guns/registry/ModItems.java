...
public class ModItems {
    ...
    //Items
    public static final Item CRYSTAL = new Item(new Item.Settings().group(FabricMod.CRYSTAL_GROUP));
    public static final Item CRYSTAL_SHARD = new Item(new Item.Settings().group(FabricMod.CRYSTAL_GROUP));
    ...
    public static final M4CarbineItem M4_CARBINE = RegistryUtils.registerItem(
            ...
            new Identifier(FabricMod.MOD_ID, "m4_carbine")
    );
    ...
    //BlockItems
    public static final BlockItem CRYSTAL_ORE = new BlockItem(ModBlocks.CRYSTAL_ORE, new Item.Settings().group(FabricMod.CRYSTAL_GROUP));
    public static final BlockItem CRYSTAL_BLOCK = new BlockItem(ModBlocks.CRYSTAL_BLOCK, new Item.Settings().group(FabricMod.CRYSTAL_GROUP));
    public static final BlockItem CRYSTAL_BRICKS = new BlockItem(ModBlocks.CRYSTAL_BRICKS, new Item.Settings().group(FabricMod.CRYSTAL_GROUP));

    public static void registerItems() {

        //Gun Items
        Registry.register(Registry.ITEM, new Identifier(FabricMod.MOD_ID, "tiny_gunpowder"), TINY_GUNPOWDER);
        Registry.register(Registry.ITEM, new Identifier(FabricMod.MOD_ID, "pistol"), SIMPLE_PISTOL);
        Registry.register(Registry.ITEM, new Identifier(FabricMod.MOD_ID, "bullet"), BULLET);
        Registry.register(Registry.ITEM, new Identifier(FabricMod.MOD_ID, "ammo_shell"), AMMO_SHELL);
        Registry.register(Registry.ITEM, new Identifier(FabricMod.MOD_ID, "ammo"), AMMO);
        //GeoItemRenderer.registerItemRenderer(M4_CARBINE, new M4CarbineRenderer());

        //Crystal Stuff
        Registry.register(Registry.ITEM, new Identifier(FabricMod.MOD_ID, "crystal"), CRYSTAL);
        Registry.register(Registry.ITEM, new Identifier(FabricMod.MOD_ID, "crystal_shard"), CRYSTAL_SHARD);

        //Blocks
        Registry.register(Registry.ITEM, new Identifier(FabricMod.MOD_ID, "crystal_ore"), CRYSTAL_ORE);
        Registry.register(Registry.ITEM, new Identifier(FabricMod.MOD_ID, "crystal_block"), CRYSTAL_BLOCK);
        Registry.register(Registry.ITEM, new Identifier(FabricMod.MOD_ID, "crystal_bricks"), CRYSTAL_BRICKS);

        //Crystal Armor
        Registry.register(Registry.ITEM, new Identifier(FabricMod.MOD_ID, "crystal_helmet"), CRYSTAL_HELMET);
        Registry.register(Registry.ITEM, new Identifier(FabricMod.MOD_ID, "crystal_chestplate"), CRYSTAL_CHESTPLATE);
        Registry.register(Registry.ITEM, new Identifier(FabricMod.MOD_ID, "crystal_leggings"), CRYSTAL_LEGGINGS);
        Registry.register(Registry.ITEM, new Identifier(FabricMod.MOD_ID, "crystal_boots"), CRYSTAL_BOOTS);
    }
}
